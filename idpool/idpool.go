// Copyright notice: this file from https://github.com/bazil/bazil/blob/master/idpool/idpool.go
...
func (p *Pool) SetMinimum(min uint64) {
	...
	// make sure the reserved ids aren't returned from the free list either
